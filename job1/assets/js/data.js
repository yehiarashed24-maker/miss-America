...
const EGYPT_AMERICAN_DATA = {
  ...
  translations: {
    en: {
      nav: { brand: "Egypt America Center", sub: "Mohammed Hammouda", home: "Home", about: "About Us", products: "Products", brands: "Brands & Partners", contact: "Contact Us", request_quote: "Request Quote" },
      ...
      cta: { title: "Ready to Upgrade Your Textile Manufacturing Facility?", desc: "Consult with our international engineers today for custom machine configurations or express spare parts dispatch.", btn: "Contact Sales Team" },
    ...
    ar: {
      nav: { brand: "مركز مصر أمريكا", sub: "محمد حمودة", home: "الرئيسية", about: "من نحن", products: "المنتجات", brands: "الوكالات والشركاء", contact: "اتصل بنا", request_quote: "طلب عرض سعر" },
      ...
      cta: { title: "هل أنت جاهز لتحديث وتطوير منشأتك الصناعية للنسيج؟", desc: "تواصل مع مهندسينا الدوليين اليوم للحصول على أحدث تكوينات الآلات أو شحن قطع الغيار الفوري.", btn: "تواصل مع فريق المبيعات" },
    ...
    zh: {
      nav: { brand: "Egypt America Center", sub: "Mohammed Hammouda", home: "首页", about: "关于我们", products: "产品中心", brands: "品牌代理", contact: "联系我们", request_quote: "索取报价" },
      ...
      cta: { title: "准备升级您的纺织制造工厂吗？", desc: "立即咨询我们的国际工程师，获取定制机械配置或急件发货。", btn: "联系销售团队" },
